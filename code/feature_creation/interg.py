...
import io
df = pd.read_csv(io.BytesIO(uploaded['interg_mutation.csv']),low_memory=False)
df.head()
...
classifier =AdaBoostClassifier(n_estimators=100,learning_rate=1) # Selecting base estimator default i.e. Decision tree
